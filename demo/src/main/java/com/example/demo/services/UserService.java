...
/*
    констроллер принимает данные от юзера и передает их на сервис, и с сервиса обратно на клиент
    сервис ответственен за работу и управление ( изменяем, манипулирует) данными
    сервис создает пользователя в бд
    хранилище достает/сохраняет данные в бд
 */
